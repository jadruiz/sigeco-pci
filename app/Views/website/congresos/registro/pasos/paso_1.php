            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <?php if (session()->has('id')): ?>
                        ...
                        <h3 class="text-center text-success mb-4">¡Ya estás autenticado!</h3>
                        <p class="text-center">Resumen de tu inscripción al congreso:</p>
                        <ul class="list-group mb-4">
                            <li class="list-group-item">
                                <strong>Nombre:</strong> <?= esc(session('nombre') . ' ' . session('apellido_paterno')) ?>
                            </li>
                            <li class="list-group-item">
                    ...
                    <?php else: ?>
                        ...
                        <div class="d-flex justify-content-center gap-3 mb-4">
                            ...
                            <a href="<?= base_url('registro/set_congreso/'.$congreso['slug']) ?>/2" class="btn btn-primary btn-lg">
                                Crear Cuenta
                            </a>
                        </div>
